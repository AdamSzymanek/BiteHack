...
const ProductGrid = ({ categorySlug, searchTerm }) => {
  ...
  const visibleProducts = useMemo(() => {
    ...
    return result; // Teraz ta linia wykona się zawsze

  }, [selectedTypes, sortOrder, categorySlug, searchTerm]);
